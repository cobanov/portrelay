...
**[Download Mac preview.4](https://github.com/cobanov/portrelay/releases/tag/v0.1.0-macos-preview.4)**
...
Sign in with the same GitHub account on Mac and Linux alpha.9. On Linux, open
**Keyboard & mouse → Enable receiving control**, then allow the Mac under
**Computers → Manage**. On Mac, open **Keyboard & mouse**, select Linux, and
click **Control [computer]**.
